...
embedvideo.innerHTML = '<video controls preload="auto" width="100%" height="100%"> <source src="//alephfiles.duckdns.org/animationarchive/Dying_Be_Like.mp4" type="video/mp4">Your browser does not support the HTML5 video tag. If you are using Internet Explorer 6, then upgrade to Internet Explorer 9 now.</video>';
}

if (videoid === "theyheightenedtheharp"){
embedvideo.innerHTML = '<video controls preload="auto" width="100%" height="100%"> <source src="//alephfiles.duckdns.org/animationarchive/flutedanceanim.mp4" type="video/mp4">Your browser does not support the HTML5 video tag. If you are using Internet Explorer 6, then upgrade to Internet Explorer 9 now.</video>';
}
